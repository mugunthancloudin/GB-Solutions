        ...
        <div className="container pt-5 pb-5">
          <div className="row">
            <div className="col-lg-6 featuresTag order-sm-0">
              <img src={devImage} className="devProfile" alt="img" />
            </div>
            <div className="col-lg-6 pb-5 order-sm-1">
              ...
              <div className="row">
                <div className="col-lg-6  col-md-6">
                  <button className="w-100 devButtons01 text-start pt-1 pb-1 ps-4">
                    <FontAwesomeIcon
                      className="me-4 test"
                      icon={faChevronRight}
                    />
                ...
                <div className="col-lg-6  col-md-6">
                  <button className="w-100 devButtons text-start pt-1 pb-1 ps-4">
                    <FontAwesomeIcon
                      className="me-4 test"
                      icon={faChevronRight}
                    />
                ...
                <div className="col-lg-6  col-md-6">
                  <button className="w-100 devButtons text-start pt-1 pb-1 ps-4">
                    <FontAwesomeIcon className="me-4" icon={faChevronRight} />
                    Android Development
                  </button>
                </div>
                <div className="col-lg-6  col-md-6">
